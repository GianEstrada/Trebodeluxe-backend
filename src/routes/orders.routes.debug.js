...
console.log('🔍 [ORDERS ROUTES] ordersController.createOrder:', typeof ordersController.createOrder);
...
console.log('✅ [ORDERS ROUTES] Rutas de órdenes configuradas exitosamente');
